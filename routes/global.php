...
return [
    ...
    [   'POST',      '/get_local_conversations',            'messaging',     'getLocalConversations'        ],
    [   'POST',      '/get_conversations',                  'messaging',     'getConversations'             ],
    [   'POST',      '/get_messages',                       'messaging',     'localGetMessages'             ],
    [   'POST',      '/read_message',                       'messaging',     'localReadMessage'             ],
    [   'POST',      '/local_send_message',                 'messaging',     'localSendMessage'             ],
    [   'POST',      '/send_message',                       'messaging',     'sendMessage'                  ],
    [   'POST',      '/local_count_unread_messages',        'messaging',     'localCountUnreadMessages'     ],
